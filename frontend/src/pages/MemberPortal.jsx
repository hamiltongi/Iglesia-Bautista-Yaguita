...
const MemberPortal = () => {
  ...
  const renderDonations = () => (
    <div className="bg-white rounded-2xl shadow-lg p-8">
      <h2 className="text-2xl font-bold text-gray-900 mb-8">Mes Dons</h2>
      <div className="text-center py-12">
        <Heart className="w-16 h-16 text-gray-400 mx-auto mb-4" />
        <p className="text-gray-500">Système de dons en cours de développement !</p>
        <p className="text-gray-400 text-sm">Bientôt vous pourrez voir l'historique de vos dons et faire de nouveaux dons.</p>
      </div>
    </div>
  );
